...
if(DEFINED changer-device0)
  set(CHANGER_DEVICE0 ${changer-device0})
else()
  set(CHANGER_DEVICE0 "/dev/tape/by-id/scsi-SSTK_L700_XYZZY_A")
  set(default_changer0 TRUE)
endif()

if(NOT EXISTS ${CHANGER_DEVICE0})
  message(STATUS "Could not find changer-device \"${CHANGER_DEVICE0}\"")
  set(error_changer0 TRUE)
endif()

if(DEFINED tape-devices0)
  list(APPEND TAPE_DEVICES0 ${tape-devices0})
else()
  list(APPEND TAPE_DEVICES0 "/dev/tape/by-id/scsi-XYZZY_A1-nst"
...
if(default_changer0 AND default_tape_devices0)
  if(error_changer0 OR error_tape_devices0)
    message(STATUS "Disabling autochanger test because one or more default devices were not found.")
  else()
    set(AUTOCHANGER_TEST_ENABLED TRUE PARENT_SCOPE)
  endif()
elseif(NOT default_changer0 AND NOT default_tape_devices0)
  if(error_changer0 OR error_tape_devices0)
    message(FATAL_ERROR "Could not find one or more devices for autochanger test.")
  else()
    set(AUTOCHANGER_TEST_ENABLED TRUE PARENT_SCOPE)
  endif()
else()
  message(FATAL_ERROR "Cannot use default and non default devices at the same time.")
endif()

if(AUTOCHANGER_TEST_ENABLED)
  list(JOIN TAPE_DEVICES0 " " found_tape_devices0)
  message(STATUS "Found valid devices for autochanger test: ${CHANGER_DEVICE0} ${found_tape_devices0}")
endif()
